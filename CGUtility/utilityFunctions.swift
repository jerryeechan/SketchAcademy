...
import Foundation
public func scaleImage(image:UIImage,scale:CGFloat)->UIImage{
    //let flipImage =
...
public func getViewController(_ identifier:String)->UIViewController
{
    return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: identifier)
    
}
public func uIntColor(_ red:UInt8,green:UInt8,blue:UInt8,alpha:UInt8)->UIColor
{
    return UIColor(red: CGFloat(red)/255, green: CGFloat(green)/255, blue: CGFloat(blue)/255, alpha: CGFloat(alpha)/255)
}
public var themeDarkColor = uIntColor(36, green: 53, blue: 62, alpha: 255)
public var themeLightColor = uIntColor(244, green: 149, blue: 40, alpha: 255)
public func DLog(_ message: String, filename: String = #file, line: Int = #line, function: String = #function){
    #if DEBUG
