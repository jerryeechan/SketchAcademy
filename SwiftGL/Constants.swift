...
public let GL_FRAMEBUFFER          = GLenum(OpenGLES.GL_FRAMEBUFFER)
public let GL_RENDERBUFFER_ENUM    = GLenum(OpenGLES.GL_RENDERBUFFER)
public let GL_RENDERBUFFER_WIDTH   = GLenum(OpenGLES.GL_RENDERBUFFER_WIDTH)
public let GL_RENDERBUFFER_HEIGHT  = GLenum(OpenGLES.GL_RENDERBUFFER_HEIGHT)
public let GL_COLOR_ATTACHMENT0    = GLenum(OpenGLES.GL_COLOR_ATTACHMENT0)
#endif
