...
class FaceGameStageLevelGenerator {
    ...
    fileprivate let imageNameSetGame1 = ["img2", "img3", "img4","img1", "img5", "img6", "img7", "img8", "img9", "img10"]
    ...
    var angrybirdPosSet:[CGPoint] = []
    
    var tumblerPosSet:[CGPoint] = []
    ...
    init(size:CGSize,num:Int)
    {
        ...
        angrybirdPosSet = [CGPoint(x:293.0,y:462.0),CGPoint(x:358.5,y:450.0),
        ...
        tumblerPosSet += [CGPoint(x:249.5,y:400.5)]
        tumblerPosSet += [
            CGPoint(x:199.5,y:482.0),
            CGPoint(x:300.3,y:481.0),
            CGPoint(x:297.6,y:455.0)
        ]
        
        tumblerPosSet += [
            CGPoint(x:202.5,y:455.0),
            CGPoint(x:233.166,y:428.0),
            CGPoint(x:266.5,y:427.0),
            CGPoint(x:317.5,y:419.5),
            CGPoint(x:182.1,y:419.5)
        ]
        tumblerPosSet += [
            CGPoint(x:250.3,y:400.0),
            CGPoint(x:363.8,y:345.5),
            CGPoint(x:135.1,y:345.5),
            CGPoint(x:344.5,y:329.0),
            CGPoint(x:155.5,y:328.5),
            CGPoint(x:182.3,y:313.5),
            CGPoint(x:316.6,y:312.5),
            CGPoint(x:249.1,y:306.0)
        ]
    ...
    func genGameLevel(_ levelName:FaceGameViewController.FaceGameLevelName)
    {
    ...
    func freeComponents()->FaceComponentSet
    {
        ...
        {
            component.position = CGPoint(x: size.width / 8 + dis * CGFloat(count%8),y: (size.height / 8) * CGFloat(count / 8 + 1))
            count += 1
        }
        return componentSet
    }
